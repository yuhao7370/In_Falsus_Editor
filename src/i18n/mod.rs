...
pub enum TextKey {
    ...
    SettingsShowBarlines,
    SettingsColorBarlines,
    SettingsDebugHitbox,
    SettingsShowMinimap,
    LanguageChinese,
    LanguageEnglish,
...
impl TextKey {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            TextKey::SettingsShowBarlines => "settings_show_barlines",
            TextKey::SettingsColorBarlines => "settings_color_barlines",
            ...
            TextKey::FileSaveProject => "file_save_project",
            ...
            TextKey::ToastBplZeroRequiresBpmZero => "toast_bpl_zero_requires_bpm_zero",
